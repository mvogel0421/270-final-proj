...
Moving to the logistic regression. The x-intercept of  ~ -0.44 suggests that yes, in fact, Pre-Trump Republican voters quite strongly were in opposition to endorsements of LGBT+ adoption. The highly postiive nature of the Trump-Era coefficient, of ~0.99, represents the strong swing of this reality in the Trump-Era, and that a Republican voter is veritably much more likely to support LGBT+ adoption than a Republican voter from times past.
