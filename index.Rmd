...
- changes in political ideology among voters (opinion on gay adoption)

Outcome Variable
- Increases in size of the Republican Party, but more specifically, a morphing of its base. (Is there more opposition to LGBT+ adoption)

Support for my hypothesis would be found if I do in fact find sufficient evidence that hate or negative feelings towards the LGBT+ community and its members' attempts to start families has risen since Trump first started captivating Americans by the millions.
